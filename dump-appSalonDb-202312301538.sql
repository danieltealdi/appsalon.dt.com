...
--
-- Host: localhost    Database: appSalonDb
-- ------------------------------------------------------
...
CREATE TABLE `citasServicios` (
  ...
  PRIMARY KEY (`id`),
  KEY `citasServicios_citas_FK` (`citas`),
  KEY `citasServicios_servicios_FK` (`servicios`),
  CONSTRAINT `citasServicios_citas_FK` FOREIGN KEY (`citas`) REFERENCES `citas` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `citasServicios_servicios_FK` FOREIGN KEY (`servicios`) REFERENCES `servicios` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'appSalonDb'
--
...
-- Dump completed on 2023-12-30 15:38:05
